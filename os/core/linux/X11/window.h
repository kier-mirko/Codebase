#ifndef BASE_LINUX_X11_WINDOW
#define BASE_LINUX_X11_WINDOW
...
#define Mod2Mod(MODIFIERS)     (((MODIFIERS) & 0x10) >> 4)
#define Mod3Mod(MODIFIERS)     (((MODIFIERS) & 0x20) >> 5)
...
fn B32 viewportShouldClose(Viewport *viewport);

fn ViewportEvent viewportGetEvent(Viewport *viewport);

fn B32 viewportSetIcon(Arena *arena, Viewport *viewport, String8 path);
fn void viewportSetTitle(Viewport *viewport, String8 title);

fn B32 isViewportFocused(Viewport *viewport);
...
fn B32 isViewportFullscreen(Viewport *viewport);
